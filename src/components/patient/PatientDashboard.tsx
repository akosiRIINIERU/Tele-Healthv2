      ...
      <div>
        ...
        <div className="bg-gradient-to-br from-pink-500 to-pink-600 px-4 md:px-6 lg:px-8 py-6 md:py-8 lg:py-10 text-white">
          <div className="flex items-center justify-between mb-4 md:mb-6">
            <button onClick={() => navigate('/patient/menu')} className="md:hidden">
          ...
          <div className="flex items-center gap-4 bg-white/20 backdrop-blur-sm rounded-xl p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 px-4 md:px-6 lg:px-8 pb-6">
          {/* Today's Health Tip */}
          <div>
            ...
            {mockHealthTips[0] && (
              <Card className="p-4 md:p-6 bg-gradient-to-br from-pink-50 to-white dark:from-gray-800 dark:to-gray-700">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-pink-100 dark:bg-pink-900 rounded-full flex items-center justify-center flex-shrink-0">
          ...
          {/* Ad Banner */}
          <div>
            <h2 className="text-gray-900 dark:text-white mb-4">Special Offers</h2>
        ...
        <div className="px-4 md:px-6 lg:px-8 pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
            {mockDoctors.slice(0, 3).map((doctor) => (
              <Card
                key={doctor.id}
                className="p-4 md:p-5 cursor-pointer hover:shadow-lg transition-shadow"
                onClick={() => navigate(`/patient/doctor/${doctor.id}`)}
              >
                <div className="flex items-center gap-3">
                  <div className="w-14 h-14 md:w-16 md:h-16 bg-gray-200 dark:bg-gray-700 rounded-full flex items-center justify-center flex-shrink-0">
